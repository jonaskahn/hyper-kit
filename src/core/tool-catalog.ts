...
interface ToolSpec {
  ...
  /* true for coding agents run from the command line (Claude Code, Codex,
     ...). Only these are matched by tab agent detection; editor launchers
     (zed, windsurf, trae) stay in the inventory but never light up a tab. */
  cliAgent?: boolean;
}
...
export const TOOL_CATALOG: ToolSpec[] = [
  // --- agents (cliAgent: terminal coding agents only — detection matches
  //     exactly these; zed/windsurf/trae are editor launchers, not agent CLIs)
  { name: 'Claude', command: 'claude', category: 'Agents', cliAgent: true },
  { name: 'Codex', command: 'codex', category: 'Agents', cliAgent: true },
  { name: 'OpenCode', command: 'opencode', category: 'Agents', cliAgent: true },
  { name: 'Cursor', command: 'agent', category: 'Agents', cliAgent: true },
  { name: 'Gemini', command: 'gemini', category: 'Agents', cliAgent: true },
  { name: 'Copilot', command: 'copilot', category: 'Agents', cliAgent: true },
  { name: 'Aider', command: 'aider', category: 'Agents', cliAgent: true },
  { name: 'Amp', command: 'amp', category: 'Agents', cliAgent: true },
  { name: 'Goose', command: 'goose', category: 'Agents', cliAgent: true },
  { name: 'Devin', command: 'devin', category: 'Agents', cliAgent: true },
  { name: 'Qwen Code', command: 'qwen', category: 'Agents', cliAgent: true },
  { name: 'Kiro', command: 'kiro', category: 'Agents', cliAgent: true },
  { name: 'Kimi', command: 'kimi', category: 'Agents', cliAgent: true },
  { name: 'OpenHands', command: 'openhands', category: 'Agents', cliAgent: true },
  { name: 'Zed', command: 'zed', category: 'Agents' },
  { name: 'Windsurf', command: 'windsurf', category: 'Agents' },
  { name: 'Antigravity', command: 'agy', category: 'Agents', cliAgent: true },
